...
#ifdef __SCU_RSTCON0
        if ( __SCU_RSTCON0_INIT)        __SCU_RSTCON0.U = __SCU_RSTCON0_VALUE;
#endif

#ifdef __SCU_RSTCON1
        if ( __SCU_RSTCON1_INIT)        __SCU_RSTCON1.U = __SCU_RSTCON1_VALUE;
#endif
...
#ifdef __SCU_PLLCON0
        if(__SCU_PLLCON0_INIT)  __SCU_PLLCON0.U = __SCU_PLLCON0_VALUE;
#endif

#ifdef __SCU_PLLCON1
        if(__SCU_PLLCON1_INIT)  __SCU_PLLCON1.U = __SCU_PLLCON1_VALUE;
#endif

#ifdef __SCU_PLLCON2
        if(__SCU_PLLCON2_INIT)  __SCU_PLLCON2.U = __SCU_PLLCON2_VALUE;
#endif

#ifdef __SCU_PLLCON3
        if(__SCU_PLLCON3_INIT)  __SCU_PLLCON3.U = __SCU_PLLCON3_VALUE;
#endif
