...
#if (SCS_F_PLL_TARGET < 1000000) || (SCS_F_PLL_TARGET > 40000000)
...
Scs_ErrorType Scs_GoFromBaseModeToNormalMode(void)
{
  ...
  // Wait for VCO lock at fSYS = internal 5 MHz, check for error
  ...
  // disable VCO bypass, check for error; new fSYS = 10 MHz
