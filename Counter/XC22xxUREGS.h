...
#ifndef _XC22xxUREGS_H_
#define _XC22xxUREGS_H_
...
// Broken Wire Detection Enable Register Extended
#define ADC0_BWDENRE           (*((uword volatile *) 0xE210))
...
#define ADC0_CHCTR16           (*((uword volatile *) 0xE220))

// Channel 17 Control Register
#define ADC0_CHCTR17           (*((uword volatile *) 0xE222))

// Channel 18 Control Register
#define ADC0_CHCTR18           (*((uword volatile *) 0xE224))

// Channel 19 Control Register
#define ADC0_CHCTR19           (*((uword volatile *) 0xE226))

// Channel 2 Control Register
#define ADC0_CHCTR2            (*((uword volatile *) 0xE024))

// Channel 20 Control Register
#define ADC0_CHCTR20           (*((uword volatile *) 0xE228))

// Channel 21 Control Register
#define ADC0_CHCTR21           (*((uword volatile *) 0xE22A))
...
// Channel Event Indication Clear Register Extended
#define ADC0_CHINCRE           (*((uword volatile *) 0xE202))

// Channel Event Indication Flag Register
#define ADC0_CHINFR            (*((uword volatile *) 0xE090))

// Channel Event Indication Flag Register Extended
#define ADC0_CHINFRE           (*((uword volatile *) 0xE200))
...
// Channel Interrupt Node Pointer Register 16
#define ADC0_CHINPR16          (*((uword volatile *) 0xE208))

// Channel Interrupt Node Pointer Register 20
#define ADC0_CHINPR20          (*((uword volatile *) 0xE20A))
...
// Conversion Request 1 Control Register Extended
#define ADC0_CRCR1E            (*((uword volatile *) 0xE214))
...
// Conversion Request 1 Pending Register Extended
#define ADC0_CRPR1E            (*((uword volatile *) 0xE216))

// Filter 0 Current Result High Register
#define ADC0_CRRH0             (*((uword volatile *) 0xE284))

// Filter 1 Current Result High Register
#define ADC0_CRRH1             (*((uword volatile *) 0xE294))

// Filter 0 Current Result Low Register
#define ADC0_CRRL0             (*((uword volatile *) 0xE282))

// Filter 1 Current Result Low Register
#define ADC0_CRRL1             (*((uword volatile *) 0xE292))
...
#define ADC0_FCR0              (*((uword volatile *) 0xE280))

// Filter 1 Control Register
#define ADC0_FCR1              (*((uword volatile *) 0xE290))

// Filter 0 Final Result Register
#define ADC0_FRR0              (*((uword volatile *) 0xE28C))

// Filter 1 Final Result Register
#define ADC0_FRR1              (*((uword volatile *) 0xE29C))
...
#define ADC0_IRR10             (*((uword volatile *) 0xE286))

// Filter 1 Intermediate Result Register 1 High
#define ADC0_IRR11H            (*((uword volatile *) 0xE298))

// Filter 1 Intermediate Result Register 1 Low
#define ADC0_IRR11L            (*((uword volatile *) 0xE296))

// Filter 0 Intermediate Result Register 2
#define ADC0_IRR20             (*((uword volatile *) 0xE288))

// Filter 0 Intermediate Result Register 3
#define ADC0_IRR30             (*((uword volatile *) 0xE28A))
...
#define ADC0_SFRR1             (*((uword volatile *) 0xE29A))

// Status Register Filter 0
#define ADC0_SRF0              (*((uword volatile *) 0xE28E))

// Status Register Filter 1
#define ADC0_SRF1              (*((uword volatile *) 0xE29E))
...
// Port 2 Digital Input Disable Register
#define P2_DIDIS               (*((uword volatile *) 0xE9FE))
...
// Port 3 Digital Input Disable Register
#define P3_DIDIS               (*((uword volatile *) 0xE9FE))
...
// Port 6 Digital Input Disable Register
#define P6_DIDIS               (*((uword volatile *) 0xFE4E))
...
// GSC Peripheral Status Register
#define SCU_GSCPERSTAT1        (*((uword volatile *) 0xFE9A))
...
#define SCU_GSCPERSTATEN1      (*((uword volatile *) 0xFF06))
#define SCU_GSCPERSTATEN1_CC1                      ((T_Reg16 *) 0xFF06)->bit1
#define SCU_GSCPERSTATEN1_FR                       ((T_Reg16 *) 0xFF06)->bit2
#define SCU_GSCPERSTATEN1_USIC4                    ((T_Reg16 *) 0xFF06)->bit0
...
// Interrupt Source Select 1 Register
#define SCU_ISSR1              (*((uword volatile *) 0xFED8))

// Interrupt Source Select 2 Register
#define SCU_ISSR2              (*((uword volatile *) 0xFEDA))
...
#define SCU_SYSCON1_TRCEN                    ((T_Reg16 *) 0xFF4C)->bit4
...
#define SCU_TRAPSTAT_FRVCOLCKT                ((T_Reg16 *) 0xFF02)->bit9
...
// WWD Control and Status Register
...
// WWD Window Boundary Count Register
#define SCU_WDTWINB            (*((uword volatile *) 0xF03C))
